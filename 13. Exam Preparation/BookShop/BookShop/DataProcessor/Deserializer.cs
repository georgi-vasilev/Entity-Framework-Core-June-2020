        ...
        public static string ImportBooks(BookShopContext context, string xmlString)
        {
            ...
            using (StringReader stringReader = new StringReader(xmlString))
            {
                ...
                foreach (ImportBookDto bookDto in bookDtos)
                {
                    ...
                    bool isDateValid = DateTime.TryParseExact(bookDto.PublishedOn, "MM/dd/yyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out publishedOn);
                    ...
                    sb.AppendLine($"Successfully imported book {validBook.Name} for { validBook.Price}.");
                }
