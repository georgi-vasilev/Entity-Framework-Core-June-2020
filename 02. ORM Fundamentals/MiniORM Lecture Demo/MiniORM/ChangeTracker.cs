namespace MiniORM
{
        ...
        where T : class, new()
    {
        ...
        public IEnumerable<T> GetModifiedEntities(DbSet<T> dbSet)
        {
            ...
            foreach (T proxyEntity in this.AllEntities)
            {
                object[] primaryKeyValues = 
                    GetPrimaryKeyValue(primaryKeys, proxyEntity)
                    .ToArray();

                T entity = dbSet
                    .Entities
                    .Single(e => GetPrimaryKeyValue(primaryKeys, e)
        ...
        private static IEnumerable<object> GetPrimaryKeyValue(IEnumerable<PropertyInfo> primaryKeys, T proxyEntity)
        {
